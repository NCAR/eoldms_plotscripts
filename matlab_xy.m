...
% file. The script takes in an OPeNDAP file. The user puts in the OPeNDAP file
% and can take variables from the file. The script shows how the data can be
% used to plot 2d plots for a given location.

% This script first reads in the OPeNDAP file either through a URL or through
% a downloaded file. The user stores the wanted information as variables
% and stores the desired station location information. The script then finds all of
...
% Display the information in the OPeNDAP file with 'ncdisp'.
...
% that MATLAB starts at 1 for counting. The increment "inc" starts at 2.
